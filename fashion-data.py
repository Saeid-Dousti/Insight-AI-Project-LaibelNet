...
def read_images(input=None):
    ...
    if input is None: #Plant seedling data
        ...
        (x_train, y_train), (x_test, y_test) = fashion_mnist.load_data() # train dataset is passed along

        image_n_label = (x_train[0:Batch_size,:], y_train[0:Batch_size])
